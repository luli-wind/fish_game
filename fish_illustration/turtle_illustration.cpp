#include "turtle_illustration.h"

turtle_illustration::turtle_illustration(QWidget *parent)
    : QWidget{parent}
{
    // 主布局：水平分栏（左图+右文）
    ...
    fishIcon->setPixmap(QPixmap(":/image/turtle1.png").scaled(200, 200, Qt::KeepAspectRatio));
    ...
    <div class="box">
    <h1 class="title">​​​​海龟 Turtle​​​</h1>
    <span class="highlight" style="font-size:16px;">「深海中的智慧旅者」​​</span>
    <p class="subtitle">📖 生态档案</p>
    <ul>
    <li><p><span class="highlight">​​千年寿命</span>​​：寿命可达百年以上，背甲纹路记录海洋生态变迁，被称为“活体航海图”。</p></li>
    <li><p><span class="highlight">共生清洁</span>​​：定期造访“清洁站”，吸引小鱼清除寄生藻类，形成独特生态协作。</p></li>
    <li><p><span class="highlight">​​​​洄游本能​​</span>​​：利用地球磁场导航，跨越数千公里完成繁殖迁徙，幼龟破壳后凭月光指引入海。</p></li>
    </ul>

    <p class="subtitle">🎮 玩家提示</p>
    <p>🎣 ​​捕获技巧​​：随心所欲去捉，大家<span class="highlight">总有一天​​</span>​​。</p>
    </div>
