...
namespace {
struct qt_meta_tag_ZN4shopE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4shopE = QtMocHelpers::stringData(
    "shop",
    "returnbtnclick",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4shopE[] = {
...
Q_CONSTINIT const QMetaObject shop::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4shopE.offsetsAndSizes,
    qt_meta_data_ZN4shopE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4shopE_t,
        // Q_OBJECT / Q_GADGET
...
void *shop::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4shopE.stringdata0))
